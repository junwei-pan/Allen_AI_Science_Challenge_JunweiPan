...
public class Get_Top_Documents_Based_on_Lucene {

  private Get_Top_Documents_Based_on_Lucene() {}
    ...
    try (BufferedReader br = new BufferedReader(new FileReader(path_train))) {
        ...
        while ((line = br.readLine()) != null) {
            ...
            try{
                ...
                doPagingSearch(in, writer, searcher, query, hitsPerPage, raw, queries == null && queryString == null);
